...
git pull = git fetch + get merge &emsp; **Merge the upstream branch into the current branch after fetching**

git pull --rebase = git fetch + git rebase &emsp; **Rebase the current branch on top of the upstream branch after fetching, creates linear history (svn update)**
